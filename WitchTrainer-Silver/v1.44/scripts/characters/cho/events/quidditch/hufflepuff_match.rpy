...
translate schinese hufflepuff_match_f492ae35:
    ...
    her "如果我没有弄错,我们的追求者ChoChang和CedricDiggory之间有一些历史." ("crooked_smile", "closed", "base", "mid")

# game/scripts/characters/cho/events/quidditch/hufflepuff_match.rpy:633
translate schinese hufflepuff_match_c03aa3c3:
...
translate schinese hufflepuff_match_16751eb0:
    ...
    her "考虑到探索者在魁地奇的角色是多么重要,他们复杂的过去可能会让其中一个人失去比赛的机会." ("open", "base", "base", "mid_soft")

# game/scripts/characters/cho/events/quidditch/hufflepuff_match.rpy:636
translate schinese hufflepuff_match_255a6287:
...
translate schinese hufflepuff_match_74c7097f:
...
translate schinese hufflepuff_match_dcc0ab29:

    # sna "Excellent..." ("snape_22", ypos="head")
    sna "太好了." ("snape_22", ypos="head")
...
translate schinese hufflepuff_match_416297a0:
...
translate schinese hufflepuff_match_8bfba6dd:
...
translate schinese hufflepuff_match_9b875631:
...
translate schinese hufflepuff_match_e45395df:
...
translate schinese hufflepuff_match_269b4d37:
    ...
    sna "{size=-4}一般说来,这只是一场震荡...虽然有时它们跌得很远,但这总是很有趣的." ("snape_20", ypos="head")

# game/scripts/characters/cho/events/quidditch/hufflepuff_match.rpy:864
translate schinese hufflepuff_match_9f57250a:
...
translate schinese hufflepuff_match_ccf4e565:
    ...
    sna "就像我说的...他们是我看那件血淋淋的东西的唯一原因,现在,介意我帮你把那件东西拿走吗?" ("snape_20", ypos="head")

# game/scripts/characters/cho/events/quidditch/hufflepuff_match.rpy:916
translate schinese hufflepuff_match_0a82fa8e:
    ...
    her "所以,我想,霍夫普夫只是又进了一个球吗?他们在这一点上甚至是不可阻挡的!" ("open", "base", "base", "L", flip=True, xpos=290, ypos="base", trans=d3)
...
translate schinese hufflepuff_match_return_ed266c35:
