...
translate schinese tonks_chitchat_reroll_8fb5757a:
    ...
    ton "别告诉麦格教授,但我曾经用她的外表来搜索学生的内衣抽屉..." ("grin", "closed", "worried", "mid")

# game/scripts/characters/tonks/chitchats.rpy:42
translate schinese tonks_chitchat_reroll_c7acbf1b:

    # ton "They didn't suspect a thing." ("soft", "wink", "base", "mid")
    ton "他们没有怀疑有什么事." ("soft", "wink", "base", "mid")

# game/scripts/characters/tonks/chitchats.rpy:45
translate schinese tonks_chitchat_reroll_411126eb:
...
translate schinese tonks_chitchat_reroll_d2ce839c:
    ...
    ton "我必须在课后留下一个学生做特别的辅导." ("open", "base", "base", "R")

# game/scripts/characters/tonks/chitchats.rpy:60
translate schinese tonks_chitchat_reroll_d76dd384:
    ...
    ton "作为对黑暗艺术的防御,我的任务是保护他们不受外部威胁和内在恶魔的伤害." ("open", "base", "base", "L")

# game/scripts/characters/tonks/chitchats.rpy:61
translate schinese tonks_chitchat_reroll_9492ff04:

    # ton "She has a lot to learn but it's getting there." ("horny", "base", "raised", "L")
    ton "她有很多东西要学习,但它已经到了那里." ("horny", "base", "raised", "L")

# game/scripts/characters/tonks/chitchats.rpy:64
translate schinese tonks_chitchat_reroll_7cfe6b90:
...
translate schinese tonks_chitchat_reroll_1ee6afec:
    ...
    ton "就在我教室外,有一条通往蜂蜜公爵的秘密通道." ("soft", "base", "base", "mid")

# game/scripts/characters/tonks/chitchats.rpy:90
translate schinese tonks_chitchat_reroll_dd8f7524:
...
translate schinese tonks_chitchat_reroll_e4e15618:
...
translate schinese tonks_chitchat_reroll_0fbb855b:
    ...
    ton "我想我做教师是正确的选择." ("open", "closed", "shocked", "mid")
...
translate schinese tonks_chitchat_reroll_c073475a:
    ...
    ton "别告诉任何人,在霍格沃茨学习的时候,我一定花了一大笔钱在托利潘牌身上." ("open", "narrow", "base", "downR")

# game/scripts/characters/tonks/chitchats.rpy:106
translate schinese tonks_chitchat_reroll_8cc1376f:
    ...
    ton "我父母以为我只是不得体的,需要替代材料,但他们寄给我的钱大部分花在美容和发型上." ("annoyed", "base", "base", "R")
...
translate schinese tonks_chitchat_reroll_4b245ed4:
    ...
    ton "我从阿拉斯托·穆迪那里学到了很多东西." ("soft", "base", "base", "mid")

# game/scripts/characters/tonks/chitchats.rpy:114
translate schinese tonks_chitchat_reroll_863dafb3:

    # ton "Never thought I'd end up being a teacher myself..." ("open", "base", "raised", "down")
    ton "从来没想到我自己会成为一名老师." ("open", "base", "raised", "down")
...
translate schinese tonks_chitchat_reroll_c01cd027:
    ...
    ton "我不喜欢别人叫我尼法朵拉,我是Tonks!" ("annoyed", "base", "annoyed", "mid")

# game/scripts/characters/tonks/chitchats.rpy:119
translate schinese tonks_chitchat_reroll_175d3032:

    # ton "Last time someone called me that, I used an engorgement charm on them." ("open", "base", "angry", "R")
    ton "上次有人打电话给我的时候,我对他们使用暴食咒." ("open", "base", "angry", "R")
...
translate schinese tonks_chitchat_reroll_3b7f28d7:
    ...
    ton "我要教她不要为她的身体感到羞耻." ("soft", "narrow", "base", "mid")

# game/scripts/characters/tonks/chitchats.rpy:136
translate schinese tonks_chitchat_reroll_1883378e:

    # ton "Today I taught the students about the {i}Tanglepest{/i}..." ("open", "base", "base", "mid")
    ton "今天我给学生讲解了{i}纠结虫{/i}." ("open", "base", "base", "mid")
...
translate schinese tonks_chitchat_reroll_db465413:
    ...
    ton "我的大部分能力都是以情感为基础的." ("open", "base", "base", "mid")
...
translate schinese tonks_chitchat_reroll_7a733229:
    ...
    ton "人们认为它是粉红色的,但那是因为我一直很饥渴." ("base", "base", "base", "down")

# game/scripts/characters/tonks/chitchats.rpy:157
translate schinese tonks_chitchat_reroll_7744e66a:
    ...
    ton "有传言说,斯内普已经设定了一个年龄线,让学生远离他的私人藏匿处." ("normal", "narrow", "base", "R")
...
translate schinese tonks_chitchat_reroll_5a426344:
    ...
    ton "苏珊是个如此可爱的女孩." ("open", "base", "base", "mid")

# game/scripts/characters/tonks/chitchats.rpy:169
translate schinese tonks_chitchat_reroll_43053dbc:

    # ton "But she really isn't very confident in her body..." ("open", "base", "raised", "R")
    ton "但她对自己的身体并不很有信心." ("open", "base", "raised", "R")
